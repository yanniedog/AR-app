...
export function classifyThreads(threads, opts = {}) {
  ...
  for (let i = 0; i < threads.length; i++) {
    ...
    // A substantive bot thread needs both an explicit disposition and GitHub
    // resolution. Resolution alone hides whether it was implemented, deferred,
    // or declined and does not satisfy the repository's ship bar.
    if (t.isResolved) {
