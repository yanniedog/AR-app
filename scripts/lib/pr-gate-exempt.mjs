 ...
 *
 * Policy: required reviewers apply to every human-initiated PR
 ...
 * @returns {'bot-authored'|'reports'|'mobile-auto-release'|null}
 */
...
export function gateExemptReason(prNumber) {
  ...
  if (isReportsOnlyFileList(paths) && isMatrixCommitTitle(view?.title)) return 'reports';
