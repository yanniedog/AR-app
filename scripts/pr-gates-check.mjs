#!/usr/bin/env node
/**
 * Aggregate AR-app PR merge gates.
...
Gates enforced:
  ...
  merge-subgates          wait + thread gates required before merge

Use this script for AR-app merge-readiness before enabling auto-merge or squash merge.`);
    process.exit(0);
  }
