...
- Qwen prioritizes high-signal text diffs within a bounded review budget, reports every reviewed and omitted path, and publishes validated findings as line-addressable review threads with direct suggested revisions. Generic explanations, invalid locations, or malformed output are not accepted as successful review output.
